...
class NativeTests(unittest.TestCase):
    def test_native_contracts_and_process_lifecycle(self):
        ...
        with tempfile.TemporaryDirectory(prefix="eink-native-tests-") as temporary:
            ...
            sources = [native / name for name in ("DisplayLanguage.swift", "CompanionContracts.swift", "ProcessHost.swift", "NativeBLEController.swift", "CompanionModel.swift", "SendPreflight.swift")]
